...
ui <- dashboardPage(
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "portfolios",
		...
		column(3, offset=1,
	  	...
	  	column(6,h2("Overal Climate Score"),gaugeOutput("stock_overall_score_gauge"))
		)
        	), #fluidrow
	...
	#	      ),
		...
		#      ),
	  	column(3,h2("Transition Risk"),textOutput("stock_transition_parameters")),
		...
		#      ),
	  	column(3,h2("Physical Risk"),textOutput("stock_physical_parameters")),
		...
		#      ),
	  	column(3,h2("Opportunities"),textOutput("stock_opportunity_parameters")),
