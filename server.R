...
# ----------------------------  
  ...
  #corpTable <- readr::read_csv("./data/scoring_engine/nonphysical/TCSDB_structure_locations.csv.cln.test.damages.allDFs.with.nonphysical.csv")
...
# ----------------------------  
  ...
  # corpTable = dbsheet9
  #corpTable <- readr::read_csv("./data/scoring_engine/nonphysical/TCSDB_structure_locations.csv.cln.damages.allDFs.with.nonphysical.csv")
  corpTable2 <- readr::read_csv("./data/scoring_engine/nonphysical/TCSDB_structure_locations.csv.cln.damages.allDFs.with.nonphysical.byparentcorp.csv")
  #corpTable2 <- readr::read_csv("./data/scoring_engine/nonphysical/TCSDB_structure_locations.csv.cln.test.damages.allDFs.with.nonphysical.byparentcorp.csv")
  parentCorp = dbsheet4
