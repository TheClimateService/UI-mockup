...
get_TCSDB_damage_function = function (damage_function_id) {
...
# The following consists of three functions.  Two of them differ only by "source" and are plotted as one jagged line.
gfx_data2 <- subset(gfx_data, grepl("V-Zone", Description) & Cover_Class == "Bldg")
