...
# Thresholds for hazus flood depth in meters.
thresholds <- c(0,1.5,3,4.5,6,7.5)
threshold_midpoints = c(0.75, 2.25, 3.75, 5.25, 6.75)
...
write.table(annual_probability_withslr,"./output/output_flood_annual_prob.csv",
            row.names=slrScenarios, col.names=slrYears)
